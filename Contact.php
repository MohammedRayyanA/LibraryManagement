...
<div class="col-sm-6" style="background-color:none;">
  ...
  <p><span class="glyphicon glyphicon-user"></span> <br><h4>Akshatha Chawan<h4><h4>VI Semester ISE<h4><p>
				<p><span class="glyphicon glyphicon-envelope"></span><br> akshatachaw@gmail.com</p>
  </div>
   <div class="col-sm-6"  class ="right-col" style="background-color:none;">
  <p><span class="glyphicon glyphicon-user"></span> <br><h4>MD Rayyan Ali<h4><h4>VI Semester ISE<h4><p>
				<p><span class="glyphicon glyphicon-envelope"></span><br> mrayyan96@gmail.com</p>

...
$_SESSION ['cardno']= $cardno;
    ...
    header("Location:http://localhost/Lib/ReturnDetailsProcess.php");
	mysqli_close($con);
}
?>
...
<div class="container">
  ...
  <br>
   <form class="form-horizontal" action="ReturnDetails.php" method="get">
  
  <div class="form-group">
      <label class="control-label col-sm-2" for="issuedid">Card No:</label>
      <div class="col-sm-6">
		<select  class="form-control" name="cardno">
       <option value=""> --------Card No-------- </option> 
    <?php include 'connection.php';
         $dd_res4=mysqli_query($con,"SELECT Distinct Card_No FROM issued");
		 
         while($row=mysqli_fetch_row($dd_res4))
         { 
     ...
     ?>
		...
		<input type="submit"  class="btn btn-primary btn-xs" name="submitissueid" value="Submit IssueId">
		<form>
      </div>
    </div>

...
if(isset($_SESSION['regno']))
    {
		 echo "s";
		  ...
		  $qq="SELECT * FROM student where RegNo='".$regno."' ";
         $result12=mysqli_query($con,$qq) or mysqli_error($con);
...
if(isset($_POST['updatestudent']))
{
		...
		if(isset($_SESSION['regno']))
    {
		 echo "s";
		  $regno=$_SESSION['regno'];
$q= "Update student set Card_No='$cardno', FirstName='$fnam',LastName='$lnam',RegNo='$reg',Year='$yr',Branch='$brn',Gender='$gen',Age='$ag',PhoneNo='$phnum',DOB='$db',Email='$eml' Where RegNo='".$regno."'";
...
<form action="ProcessUpdateDetails.php" method="post">
 <label for="cardno">Card No</label>
<input type="text|numeric"  name="cardno" class="form-control" value="<?php echo $row['Card_No']; ?>">
...
<label for="reg-no">Register No</label>
 <input type="text|numeric" class="form-control" name="regno" value="<?php echo $row['RegNo']; ?>">
 <label for="semester" class="m-t-10">Year</label>
 <input type="numeric|text" class="form-control" name="year" value="<?php echo $row['Year']; ?>">
<label for="branch" class="m-t-10">Branch</label>
 <input type="textNumeric" class="form-control" name="branch" value="<?php echo $row['Branch']; ?>">
<label for="gender" class="m-t-10">Your Gender</label>
 <input type="text|numeric" class="form-control" name="gender" value="<?php echo $row['Gender']; ?>">
 <label for="age">Age</label>
 <input type="numeric" class="form-control" name="age" value="<?php echo $row['Age']; ?>">
<label for="p.no">Mobile Number</label>
 <input type="numeric" class="form-control" name="phno" value="<?php echo $row['PhoneNo']; ?>">
...
<br>
<center>
<input type="submit" class="btn btn-primary m-t-5" name="updatestudent" value="Update">
</center>
</form>
</div>
            </div>

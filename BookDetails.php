...
$check1=mysqli_query($con,"select * from books where BookTitle='$btitle'");
    $checkrows1=mysqli_num_rows($check1);

   if($checkrows1>0) {
      echo '<script language="javascript">';
                echo 'alert("Book Already Present")';
                   echo '</script>';
   }else{
	$sql4 = "insert into Books values('$btitle','$publisher','$authorname','$category','$quantity')";
	
	$res4=mysqli_query($con,$sql4) or die("hhjjjjjj".mysqli_error($con));
...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="BookDetails.php" accept-charset="UTF-8">
        
                        <label for="btitle">Book Title</label>
                        <input type="text" id="btitle" class="form-control" name="btitle" placeholder="Example: Data Structure ">
                        
                         <label for="publisher">Publisher</label>
                        <input type="text" id="publisher" class="form-control" name="publisher" placeholder="Example: Hill Publication">

                         <label for="authorname">Author Name</label>
                        <input type="text" id="authorname" class="form-control" name="authorname" placeholder="Example:R.D Sharma ">

						<label for="category">Category</label>
						<select id="category" class="form-control" name="category">
                        <option value=""> --------Category-------- </option> 
						 <?php include 'connection.php';
                         $dd_res6=mysqli_query($con,"SELECT Distinct CategoryName FROM Category");
		 
         while($row6=mysqli_fetch_row($dd_res6))
         { 
     ...
     ?>
                        ...
                        <input type="numeric"  class="form-control" name="quantity" placeholder="Example: 7">
						<br>
                        <center><input type="submit" class="btn btn-primary m-t-10"  name="submitbook" value="Submit Book Details"></center>
